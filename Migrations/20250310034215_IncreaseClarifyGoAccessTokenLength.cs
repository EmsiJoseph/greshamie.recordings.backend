...
{
    /// <inheritdoc />
    public partial class IncreaseClarifyGoAccessTokenLength : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ClarifyGoAccessToken = table.Column<string>(type: "nvarchar(max)", maxLength: 100, nullable: true),
                    ClarifyGoAccessTokenExpiry = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RefreshToken = table.Column<string>(type: "nvarchar(max)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    StreamingUrl = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    DownloadUrl = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    RecordingDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime", nullable: true),
                    Caller = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Callee = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "5cbb853d-9c21-4809-a34f-165aaa76b416", new DateTime(2025, 3, 10, 3, 42, 14, 653, DateTimeKind.Utc).AddTicks(7445), "Administrator role", true, 0, "Admin", "ADMIN", new DateTime(2025, 3, 10, 3, 42, 14, 653, DateTimeKind.Utc).AddTicks(7448) },
                    { "2", "99317ff0-c1ba-451a-9bf2-109e539e2ba1", new DateTime(2025, 3, 10, 3, 42, 14, 660, DateTimeKind.Utc).AddTicks(6229), "User role", true, 0, "User", "USER", new DateTime(2025, 3, 10, 3, 42, 14, 660, DateTimeKind.Utc).AddTicks(6235) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, null, null, "1d36401c-37d0-4562-90fa-d163a4062092", null, true, false, null, null, "GHIE-API", "AQAAAAIAAYagAAAAEF714DWUJDbO2nSfJxKSkq6rkrcBwXSK26en2Ndy8truv2oF+VncQheJ0+ZgOtyzpQ==", null, false, null, null, "2903826d-902a-4d98-94aa-7a034164e43d", false, "GHIE-API" });
